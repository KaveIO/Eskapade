...
# * Macro  : esk304_histogrammar_fill_and_plot                                                  *
# * Created: 2017/02/17                                                            *
# * Description:                                                                   *
...
import logging, os
log = logging.getLogger('macro.esk304_histogrammar_fill_and_plot')
...
log.debug('Now parsing configuration file esk304_histogrammar_fill_and_plot.py')

#########################################################################################
# --- minimal analysis information
settings = ProcessManager().service(ConfigObject)
settings['analysisName'] = 'esk304_histogrammar_fill_and_plot'
settings['version'] = 0
...
log.debug('Done parsing configuration file esk304_histogrammar_fill_and_plot.py')
