...
from ..helpers import apply_transform_funcs, process_transform_funcs
...
class TransformFuncsTest(unittest.TestCase):
    ...
    @mock.patch('eskapade.helpers.log')
    @mock.patch('eskapade.helpers.type')
    @mock.patch('eskapade.helpers.process_transform_funcs')
    def test_apply_transform_funcs(self, mock_process, mock_type, mock_log):
    ...
    @mock.patch('eskapade.helpers.log')
    def test_process_transform_funcs(self, mock_log):
