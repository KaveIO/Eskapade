...
class TruncExponentialTest(unittest.TestCase):
    ...
    def test_build_model(self):
        ...
        self.assertTrue(any(c[0] and isinstance(c[0][0], str)
                            and c[0][0].startswith('TruncExponential::my_trunc_exp(')
                            and c[0][0].endswith(')') for c in mock_ws.factory.call_args_list),
