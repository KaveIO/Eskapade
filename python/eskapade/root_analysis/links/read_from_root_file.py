...
class ReadFromRootFile(Link):
    """Link to read objects from a ROOT file an put them into the data store or workspace"""
    ...
    def __init__(self, **kwargs):
        ...
        :param bool into_ws: if true, store in workspace, not datastore. Default is False
        """
