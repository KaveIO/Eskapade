...
public:
  ...
  virtual TObject* clone(const char* newname) const { return new RooABCDHistPdf(*this,newname); }
  virtual ~RooABCDHistPdf();

  inline Bool_t getABCD() const { return _abcd; }
