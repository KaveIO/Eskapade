...
public:
  ...
  RooArgList exp() {return RooArgList(_exp);}
  RooArgList fracs() {return RooArgList(_fracs);}
  ...
  Bool_t ignoreMax() {return _ignoreMax;}
  void setIgnoreMax(Bool_t ignore = kTRUE) {_ignoreMax = ignore;}
