...
# /opt/KaveToolbox/pro/scripts/KaveEnv.sh will be replaced when this file is copied to /etc/profile.d/

if [ -e /opt/KaveToolbox/pro/scripts/KaveEnv.sh ] && [[ -z "${KAVETOOLBOX}" ]]; then
